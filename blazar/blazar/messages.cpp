...
void show_module(ProgramModule module)
{
    ...
    switch(module)
    {
		...
		case Module_radiativeLosses:
			printf("Radiative Losses");
			break; 
		
		case Module_Injection:
            printf("Injection of electrons/protons");
            break;
		...
		case Module_Distribution:
            printf("Electron/proton Distribution ");
            break;
